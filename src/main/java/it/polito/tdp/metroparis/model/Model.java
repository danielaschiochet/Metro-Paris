...
//				this.grafo.setEdgeWeight(e, distanza);
			...
			double distanza = LatLngTool.distance(coppia.getP().getCoords(),
					coppia.getA().getCoords(), LengthUnit.METER) ;
			
			Graphs.addEdge(this.grafo, coppia.getP(), coppia.getA(), distanza) ;
